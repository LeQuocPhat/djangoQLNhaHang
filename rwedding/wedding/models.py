...
class WeddingHalls(MyBase):
    image = models.ImageField(upload_to='static/wedding-hall/%Y/%m', default=None)
...
class Service(MyBase):
    description = models.TextField()
    image = models.ImageField(upload_to='static/service/%Y/%m', default=None)
    system = models.ForeignKey('System', related_name="services",
                               on_delete=models.SET_NULL, null=True)


class Food(MyBase):
    image = models.ImageField(upload_to='static/food/%Y/%m', default=None)
    menu = models.ForeignKey('Menu', related_name="foods",
                             on_delete=models.SET_NULL, null=True)


class Menu(MyBase):
    image = models.ImageField(upload_to='static/menu/%Y/%m', default=None)
